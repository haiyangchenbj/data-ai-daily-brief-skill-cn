...
1. 🔍 **Search** the web for the latest developments in your industry
...
- 🔍 **Automated intelligence gathering** — web search + source verification
...
- 🎯 **Quality over quantity** — sections left empty rather than filled with low-relevance content
...
├── daily-brief-config.json     # Config file (generated by init_config.py)
├── scripts/
│   ├── init_config.py          # Initialize default config
│   ├── send_wecom.py           # 🇨🇳 WeChat Work
...
- **Open Source**: Iceberg · Hudi · Paimon · Delta Lake · Trino · Spark · Flink · Kafka · DuckDB · StarRocks · Doris
